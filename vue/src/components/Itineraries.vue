<template>
  <div class="wrapper">
    ...
    >
      ...
      <button class = "delete">
    <svg v-on:click.prevent="deleteItinerary(itinerary.itineraryId)" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
