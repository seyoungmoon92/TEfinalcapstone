<template>
  <div class="page">
    ...
    <div class="flex">
      ...
      <div class="fun-facts">
        <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-right-text" viewBox="0 0 16 16">
...
.address-description {
  ...
  margin-bottom: 60px;
  widows: 80%;
  text-shadow: 0px 0px 5px #db4dff;
...
.title {
  ...
  color: #ff006a;
  text-shadow: 0px 0px 10px #ff006a;
