...
INSERT INTO landmarks (landmarkId, name, address, description, rating , isActive, funFact1, funFact2, funFact3) VALUES (1, 'Tokyo National Museum', '13-9 Uenokoen, Taito City, Tokyo 110-8712, Japan', 'The Tokyo National Museum is an art museum in Ueno Park in the Taito ward of Tokyo, Japan. It is one of the four museums operated by the National Institutes for Cultural Heritage , is considered the oldest national museum in Japan, is the largest art museum in Japan, and is one of the largest art museums in the world.', 4, true, 'Was originally known as the Imperial Museum until 1886.', 'Is the oldest and largest museum in Japan.', 'Is an art museum that collects houses, and preserves a collection of art works and archaeological objects of Asia.');
